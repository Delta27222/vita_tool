          ...
          <div className="container px-4 mx-auto md:px-6">
            <div className="grid grid-cols-1 gap-12 md:grid-cols-2 items-center">
              ...
              <div className="relative flex flex-col justify-start items-center border border-blue-700">
                ...
                <FrontComputer className={`${isSafari ? 'scale-80 left-[30px] top-[90px] md:scale-95 md:mr-10 md:left-[50px] lg:top-[130px]' : 'scale-75 left-[50px] top-[130px] md:left-[120px] lg:top-[147px]'} absolute md:flex"`} />
              </div>
            </div>
          </div>
        </section>
